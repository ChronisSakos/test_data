...
def main():
  ...
  print('Duration:','%.2f ms' % (t))  
  print('Latency:', '%.2f ms' % (t / args.count))  
  print('Avg Latency:', '%.2f ms' % (lat)) 
  print('Throughput:', '%.2f FPS' % (1000 * (args.count-1) / summ))
  print('InputShape:', image.size)
